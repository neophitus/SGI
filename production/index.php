...
<html lang="en">
  <head>
    ...
    <link href="../vendors/jtable.2.4.0/themes/lightcolor/gray/jtable.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-home"></i> <span>ITV Admin</span></a>
            </div>
                ...
                <div class="menu_section">
                    <ul class="nav side-menu">
                        ...
                        <li><a><i class="fa fa-filter"></i> Filtros <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="index.html">Filtro por Bairros</a></li>
                                <li><a href="index2.html">Filtro por Partidos</a></li>
                                <li><a href="index3.html">Filtro por Tipo</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <footer>
          <div class="pull-right">
            SGI - Sistema de Gerenciamento Integrado | Desenvolvido por <a href="https://www.hexaconsult.com.br.com">Hexaconsult</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script src="../vendors/jtable.2.4.0/jquery.jtable.min.js" type="text/javascript"></script>
    <!-- Bootstrap -->
